...
L_MINIMAP_FARM = "Minimap Farm size"
...
L_INFO_SETTINGS_SKADA = "Type /settings skada, to apply the settings for Skada."
L_INFO_SETTINGS_DETAILS = "Type /settings details, to apply the settings for details."
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Resets Viks_ConfigUI settings.",
