...
--	Translation: Vik, Wetxius
----------------------------------------------------------------------------------------
-- Misc
L_MISC_UI_OUTDATED = "Ваша версия ViksUI устарела. Вы можете скачать последнюю версию с https://github.com/EsreverWoW/ShestakUI_Classic"
