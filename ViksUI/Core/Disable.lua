...
----------------------------------------------------------------------------------------
if C_AddOns.IsAddOnLoaded("Stuf") or C_AddOns.IsAddOnLoaded("PitBull4") or C_AddOns.IsAddOnLoaded("ShadowedUnitFrames") or C_AddOns.IsAddOnLoaded("LunaUnitFrames") then
...
if C_AddOns.IsAddOnLoaded("Gladius") or C_AddOns.IsAddOnLoaded("GladiusEx") or C_AddOns.IsAddOnLoaded("Gladdy") then
	C.unitframe.show_arena = false
end

if C_AddOns.IsAddOnLoaded("Omen") or C_AddOns.IsAddOnLoaded("rThreat") or C_AddOns.IsAddOnLoaded("ClassicThreatMeter") or C_AddOns.IsAddOnLoaded("ThreatClassic2") then
...
if C_AddOns.IsAddOnLoaded("AdiBags") or C_AddOns.IsAddOnLoaded("ArkInventory") or C_AddOns.IsAddOnLoaded("cargBags_Nivaya") or C_AddOns.IsAddOnLoaded("cargBags") or C_AddOns.IsAddOnLoaded("Bagnon") or C_AddOns.IsAddOnLoaded("Combuctor") or C_AddOns.IsAddOnLoaded("TBag") or C_AddOns.IsAddOnLoaded("BaudBag") or C_AddOns.IsAddOnLoaded("Baganator") then
	C.bag.enable = false
end
