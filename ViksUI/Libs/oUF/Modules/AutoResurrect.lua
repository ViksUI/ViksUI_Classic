...
if C.unitframe.enable ~= true or C.unitframe.plugins_auto_resurrection ~= true or C.misc.click_cast == true or T.class == "ROGUE" or T.class == "WARRIOR" or T.class == "HUNTER" or T.class == "MAGE" or (IsClassicBuild() and T.class == "WARLOCK")then return end
