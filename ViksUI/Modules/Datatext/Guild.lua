...
Stat:SetScript("OnEnter", function(self)
	...
	local guildName, guildRank, _, guildLevel = GetGuildInfo('player')

	GameTooltip:SetOwner(self, "ANCHOR_TOP", -20, 6)
	GameTooltip:ClearLines()
	-- Patch: Use guildLevel if present, otherwise just guildName
	if guildLevel then
		GameTooltip:AddDoubleLine(format(guildInfoString, guildName or "Guild", guildLevel), format(guildInfoString2, online, total), tthead.r, tthead.g, tthead.b, tthead.r, tthead.g, tthead.b)
	else
		GameTooltip:AddDoubleLine(guildName or "Guild", format(guildInfoString2, online, total), tthead.r, tthead.g, tthead.b, tthead.r, tthead.g, tthead.b)
	end
