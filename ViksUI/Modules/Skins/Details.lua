...
hooksecurefunc(_detalhes, "SetFontOutline", function(_, fontString)
	...
	if fonte == "Interface\\AddOns\\ViksUI\\Media\\Font\\pixel.ttf" then
...
local skinTable = {
	...
	instance_cprops = {
		...
		["row_info"] = {
			...
			["font_size"] = 8,
			["height"] = 14,
			["texture_file"] = "AddOns\\ViksUI\\Media\\Textures\\Texture.tga",
			...
			["texture_custom"] = "AddOns\\ViksUI\\Media\\Textures\\Texture.tga",
			["texture"] = "Smooth!",
			["textL_class_colors"] = false,
			["alpha"] = 1,
			["no_icon"] = false,
			["texture_background"] = "Smooth!",
			["texture_background_file"] = "AddOns\\ViksUI\\Media\\Textures\\Texture.tga",
			["font_face"] = "Hooge",
			["font_shadow"] = "OUTLINE",
